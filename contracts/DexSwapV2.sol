...
contract DexSwapV2 is Initializable, OwnableUpgradeable, ERC20Upgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable, WhitelistRole {
    ...
    mapping(address => uint256) private _locks;             // Current locked DEXS of each address
    ...
    /**
     * @dev Return total DEXS balance of a address.
     */
    ...
    /**
     * @dev Return locked DEXS token of a address.
     */
    ...
    /**
     * @dev Lock a DEXS token amount of a address.
     */
    ...
    /**
     * @dev Return number of DEXS token that the address can unlock.
     */
    ...
    /**
     * @dev Unlock DEXS token for the sender
     */
    function unlock() public {
        require(_locks[msg.sender] > 0, "DexSwap: there aren't DEXS to unlock");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override(ERC20Upgradeable) {
        require(block.number > allowTransferOn || hasRole(WHITELIST_ROLE, sender), "DexSwap: your DEXS can't transfer right now");
